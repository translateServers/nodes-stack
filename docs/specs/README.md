...
| 大屏设计器 Web Component SDK | [screen-web-component-sdk/](./screen-web-component-sdk/spec.md) | 设计中（2026-07-30） | 仅前端的 `<nebula-screen-editor>` SDK：宿主 Adapter、版本化文档、Shadow DOM、多实例隔离与私有 ESM 发布契约 |
