...
| 大屏设计器 Web Component SDK | [screen-web-component-sdk/](./screen-web-component-sdk/spec.md) | 实施中（2026-07-31） | 阶段 4 已完成：Workbench、static profile、composed requests、SDK UI primitives 与依赖边界已建立；待阶段 5 Host Adapter |
