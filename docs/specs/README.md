...
| 大屏设计器 Web Component SDK | [screen-web-component-sdk/](./screen-web-component-sdk/spec.md) | 实施中（2026-07-30） | 阶段 2 Checkpoint A 已完成：workspace package、版本化静态文档、Adapter、错误与 JSON Schema 契约已落地 |
