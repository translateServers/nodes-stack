...
| 大屏设计器 Web Component SDK | [screen-web-component-sdk/](./screen-web-component-sdk/spec.md) | 实施中（2026-07-31） | 阶段 5 已完成：Host Adapter 控制器、跨 mutation 协调、Envelope 基线、导入导出与快照闭环已建立；待阶段 6 Web Component 与 Shadow DOM |
