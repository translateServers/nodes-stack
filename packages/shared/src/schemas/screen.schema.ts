...
export type ScreenProjectData = z.infer<typeof ScreenProjectSchema>;
...
export type CanvasConfigData = z.infer<typeof CanvasConfigSchema>;
export type ScreenComponentData = z.infer<typeof ScreenComponentSchema>;
export type ComponentPositionData = z.infer<typeof ComponentPositionSchema>;
export type ComponentStyleData = z.infer<typeof ComponentStyleSchema>;
export type ComponentStatusData = z.infer<typeof ComponentStatusSchema>;
export type DataSourceConfigData = z.infer<typeof DataSourceConfigSchema>;
export type ApiDataSourceConfigData = z.infer<typeof ApiDataSourceConfigSchema>;
