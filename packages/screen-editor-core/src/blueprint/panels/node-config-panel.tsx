 ...
 * 写回通过 NodeConfigChange 判别联合，调用方按 kind 分发更新 node.data 字段。
 *
...
export interface NodeConfigPanelProps {
  ...
  onChange: (next: NodeConfigChange) => void;
}
...
/**
 * Node configuration panel dispatches forms by node kind and global type.
 */
export function NodeConfigPanel({ node, components, onChange }: NodeConfigPanelProps): JSX.Element {
    ...
    >
      ...
      <div className="mb-2.5 flex items-center gap-1.5">
        ...
        <span
          ...
          data-testid="node-config-kind-badge"
        >
          {kindBadge.label}
        </span>
      </div>
  ...
  return (
    <label className="block">
      ...
      <select
        ...
        data-testid="config-component-id"
      >
    ...
    <div className="space-y-2.5">
      <label className="block">
        ...
        <input
          ...
          className={controlClassName}
          data-testid="config-navigate-url"
        />
      </label>
      <label className="block">
        ...
        <select
          ...
          className={controlClassName}
          data-testid="config-navigate-target"
        >
    ...
    <div className="space-y-2.5">
      <label className="block">
        ...
        <select
          ...
          className={controlClassName}
          data-testid="config-request-api-method"
        >
      ...
      <label className="block">
        ...
        <input
          ...
          className={controlClassName}
          data-testid="config-request-api-url"
        />
      </label>
  ...
  return (
    <label className="block">
      ...
      <select
        ...
        className={controlClassName}
        data-testid="config-scroll-to-target"
      >
        <option value="">请选择组件</option>
        {components.map((comp) => (
          <option key={comp.id} value={comp.id}>
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className={controlClassName}
        data-testid="config-interval-ms"
      />
    </label>
  );
}
