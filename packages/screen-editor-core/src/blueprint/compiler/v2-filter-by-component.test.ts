...
import { filterV2BlueprintByComponent } from './v2-filter-by-component.js';
...
describe('filterV2BlueprintByComponent — V2 按组件过滤', () => {
  it('1. 过滤返回相关节点 ID', () => {
    ...
    const result = filterV2BlueprintByComponent(bp, 'comp1');
