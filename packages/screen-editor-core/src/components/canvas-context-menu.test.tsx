...
vi.mock('@nebula/screen-editor-core/internal', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@nebula/screen-editor-core/internal')>()),
  ContextMenu: ({
    children,
    onOpenChange,
  }: {
...
function EnvironmentWrapper({ children }: { children: React.ReactNode }): React.ReactElement {
  return (
