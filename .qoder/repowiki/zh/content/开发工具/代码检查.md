...
SetTsRoot --> Ignores["配置忽略项: eslint.config.mjs, jest.config.js, dist/**, coverage/**"]
...
- 忽略项：
  ...
  - 应用层可在自身配置中追加忽略项，避免误报或性能问题

章节来源
- [packages/eslint-config/base.js:18-28](file://packages/eslint-config/base.js#L18-L28)
- [apps/nestjs-server/eslint.config.mjs:18-19](file://apps/nestjs-server/eslint.config.mjs#L18-L19)
- [apps/web/eslint.config.mjs](file://apps/web/eslint.config.mjs#L7)
...
## 结论
本项目通过共享 ESLint 配置包实现了跨技术栈的一致性与可维护性，同时在 NestJS 与 Web 应用中分别针对服务端与前端特性进行了定制。配合 TypeScript 类型检查与 Prettier 协同、完善的 IDE 与 CI/CD 流程，能够有效提升代码质量与团队协作效率。
